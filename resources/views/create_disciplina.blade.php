        ...
        <div class="form-row">
          ...
          <div class="form-row">
            <div class="form-group col-md-8">
              ...
              <input type="text" class="form-control" name="descricao" placeholder="Teórico ou Prático" required>
            </div>
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" name="carga_horaria" Placeholder="Valores: 30, 60, 90, 120" required>
            </div>
          </div>
        </div>
