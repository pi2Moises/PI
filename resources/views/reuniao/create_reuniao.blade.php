					...
					<th>
						<div class="form-row">
							<div class="form-group col-md-4">
								...
								<input type="text" class="form-control" name="dt_reuniao" placeholder="ex: 01/01/1991" required>
							</div>
							<div class="form-group col-md-8">
								<label for="inputCity">Local da reunião</label>
								<input type="text" class="form-control" name="local_reuniao" required>
							</div>
							<div class="form-group col-md-12">
								<label for="inputCity">Participantes</label>
								<input type="text" class="form-control" name="participantes" placeholder="participante 1, participante 2, ..." required>
							</div>
							<div class="form-group col-md-12">
								<label for="inputCity">Deliberações</label>
								<textarea class="form-control" rows="6" name="deliberacoes"></textarea>
							</div>							
						</div>
						<br>
						<br>
